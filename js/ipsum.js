var lib = [
  ...
  'Os campeões foram funcionários da derrota,os derrotados serão os gerentes da derrota?',
  'Uma grande empresa não é classificada apenas pelo numero de funcionários mais sim pelo esforço e determinação de cada um.',
